...
import { Heading1, Wrapper } from "../../styles/dashboard.style";
import {
    AddButton,
    InnerContainer,
    Table,
    Top,
} from "../../styles/patients.style";
...
const Patients = () => {
    ...
    return (
        <Wrapper>
            <InnerContainer>
                <Top>
                    <Heading1>Patient Directory</Heading1>
                ...
                <AddButton onClick={() => router.push("/patients/add-patient")}>
                    Add new patient
                </AddButton>
